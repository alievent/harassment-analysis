...
class Model(object):
    ...
    def add_bilstm_layer(self):
        ...
        self.bilstm_outputs, self.bilstm_output_states = tf.nn.bidirectional_dynamic_rnn(lstm_fw_cell, lstm_bw_cell, self.embedded_words,
    ...
    def doc_prediction(self):
        ...
        doc_features = tf.concat((self.bilstm_output_states[0][1],self.bilstm_output_states[1][1]), 1)
        print(doc_features)
        for cls_name in self.cls_names:
